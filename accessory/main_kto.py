...
from accessory.model.kto import KTOModel
from accessory.engine_kto import train_one_epoch as train_one_epoch_kto
from accessory.data.alpaca import KTOFinetuneDataset, FinetuneDataset, FinetuneDistSampler
...
def main(args):
    ...
    if args.quant:
        ...
        with default_tensor_type(dtype=mixed_precision_dtype, device="cuda"):
            ...
            """model = MetaModel(args.llama_type, args.llama_config,
                            args.tokenizer_path, with_visual=not args.no_visual,
                            max_seq_len=args.max_words)"""
            model = KTOModel(args.beta, args.desirable_weight, args.undesirable_weight, **kwargs)
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch_kto(
